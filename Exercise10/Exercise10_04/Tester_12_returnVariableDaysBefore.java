...
/* 
 * クラス名 Tester_12_returnVariableDaysBefore
 * 概要 対象の日付を指定した日数分さかのぼった日付を表示する
 * 作成者 Y.Saeki
 * 作成日 2024/05/24
 */
public class Tester_12_returnVariableDaysBefore {
	//Scannerクラスに変数を設定。
	...
	public static void main(String[] args) {
		...
		Day multipulBeforeDay = new Day(inputDay("対象の日付を入力してください。"));
		//さかのぼりたい日数を入力させる
		int turnBackDate = inputIntegralNumber("さかのぼる日数：");
		//指定された日数分さかのぼった日付を表示。
		System.out.println(turnBackDate + "日さかのぼった日付は" + multipulBeforeDay.goMultipulBeforeDay(turnBackDate) + "です。");
