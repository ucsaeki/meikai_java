...
/* 
 * クラス名 Tester_10_returnVariableDayAfter
 * 概要 対象の日付から指定した日数経過した日付を表示する
 * 作成者 Y.Saeki
 * 作成日 2024/05/24
 */
public class Tester_10_returnVariableDayAfter {
	//Scannerクラスに変数を設定。
	...
	public static void main(String[] args) {
		...
		Day multipulAfterDay = new Day(inputDay("対象の日付を入力してください。"));
		//経過させる日数を入力させる
		int moveOnDate = inputIntegralNumber("経過させる日数：");
		//指定された日数分経過させた日付を表示。
		System.out.println(moveOnDate + "日経過した日付は" + multipulAfterDay.goMultipulAfterDay(moveOnDate) + "です。");
	}
